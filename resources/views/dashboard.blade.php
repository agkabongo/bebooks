...
<div class="text-gray-900 bg-gray-200">
    <div class="container p-4 flex space-between justify-between min-w-3xl">
        ...
        <button class="text-3xl"><a href="/create">Add a book</a></button>
        ...
        <table class="w-full text-md bg-white shadow-md rounded mb-4">
            <tbody>
                ...
                <tr class="border-b hover:bg-orange-100">
                    <td class="text-left p-3 px-5">{{ $book-> Title }}</td>
                    <td class="text-left p-3 px-5">{{ $book-> Author }}</td>
                    <td class="text-left p-3 px-5">{{ $book->Genre }}</td>

...
<div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
    ...
    <img src="https://img.icons8.com/wired/64/000000/book-shelf.png"/>
      ...
      <span class="ml- text-xl">BeBooks</span>
    </a>
    ...
    <button class="inline-flex items-center bg-gray-100 border-0 py-1 px-3 focus:outline-none hover:bg-gray-200 rounded text-base mt-4 md:mt-0"><a href="/admin">@auth Dashboard @endauth @guest Login @endguest</a>
